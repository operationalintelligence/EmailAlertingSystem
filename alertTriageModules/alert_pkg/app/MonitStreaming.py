...
class MonitStreaming:
    def consume(self,spark,schema):
        raw_data = spark.readStream.format("kafka").option("kafka.bootstrap.servers", "monit-kafka.cern.ch:9092")\
    ...
    def startMonit(self,streamingDF):
